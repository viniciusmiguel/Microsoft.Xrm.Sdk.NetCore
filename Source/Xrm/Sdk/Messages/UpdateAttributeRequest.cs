...
namespace Microsoft.Xrm.Sdk.Messages
{
  ...
  public sealed class UpdateAttributeRequest : OrganizationRequest
  {
    ...
    {
      get => Parameters.Contains(nameof (Attribute)) ? (AttributeMetadata) Parameters[nameof (Attribute)] : null;
      set => Parameters[nameof (Attribute)] = value;
    }
