...
// Type: Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest
...
{
  /// <summary>Organization request for CreateMultiple SDK message.</summary>
  ...
  public sealed class CreateMultipleRequest : OrganizationRequest
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest" /> class.
    /// </summary>
